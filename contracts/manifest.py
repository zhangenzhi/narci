"""narci.contracts.manifest —— nyx↔narci alpha 模型契约.

SAMPLING_MODES / TARGET_KINDS / MODEL_OUTPUT_UNITS / Manifest:nyx 写 manifest.json,
narci 加载时校验。P5 从 calibration/alpha_models.py 拆出。
"""
