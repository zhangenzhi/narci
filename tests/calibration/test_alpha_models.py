...
from analytics.calibration.alpha_models import (
    Manifest, OLSAlphaModel, load_alpha_model, MANIFEST_SCHEMA_VERSION,
)
from analytics.features import FeatureBuilder, FEATURE_NAMES, FEATURES_VERSION
...
def test_bj_target_kind_and_sampling_mode_accepted():
    ...
    from analytics.calibration.alpha_models import TARGET_KINDS, SAMPLING_MODES
