...
**Builder**:`scripts/research/data_integrity_v10_window.py` (commit pending)
...
参见 `scripts/research/data_integrity_v10_window.py` 输出(写入 `/tmp/data_integrity_v10_window.txt`)。
